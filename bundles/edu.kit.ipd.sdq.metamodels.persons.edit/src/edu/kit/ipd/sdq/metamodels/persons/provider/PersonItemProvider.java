...
/**
 * This is the item provider adapter for a {@link edu.kit.ipd.sdq.metamodels.persons.Person} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PersonItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Person_fullName_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Person_fullName_feature", "_UI_Person_type"),
				 PersonsPackage.Literals.PERSON__FULL_NAME,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Person)object).getFullName();
