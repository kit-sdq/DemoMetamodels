 ...
 * @generated
 */
public class RecipientsSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case RecipientsPackage.IDENTIFIED_ELEMENT: {
			...
			case RecipientsPackage.RECIPIENT: {
				...
				if (result == null) result = caseIdentifiedElement(recipient);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case RecipientsPackage.LOCATION: {
				Location location = (Location)theEObject;
				T result = caseLocation(location);
				if (result == null) result = caseIdentifiedElement(location);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case RecipientsPackage.CITY: {
