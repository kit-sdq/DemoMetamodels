 ...
 * </p>
 * <ul>
 *   <li>{@link edu.kit.ipd.sdq.metamodels.addresses.impl.AddressImpl#getParent <em>Parent</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.metamodels.addresses.impl.AddressImpl#getNumber <em>Number</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.metamodels.addresses.impl.AddressImpl#getStreet <em>Street</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.metamodels.addresses.impl.AddressImpl#getZipCode <em>Zip Code</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AddressImpl extends IdentifiedElementImpl implements Address {
	/**
