/**
 */
package edu.kit.ipd.sdq.metamodels.recipients.provider;
...
/**
 * This is the item provider adapter for a {@link edu.kit.ipd.sdq.metamodels.recipients.Recipient} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RecipientItemProvider extends IdentifiedElementItemProvider {
	/**
	...
	/**
	 * This adds a property descriptor for the Located In feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addLocatedInPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Recipient_locatedIn_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Recipient_locatedIn_feature", "_UI_Recipient_type"),
				 RecipientsPackage.Literals.RECIPIENT__LOCATED_IN,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(RecipientsPackage.Literals.RECIPIENT__LOCATED_AT);
		}
	...
	public String getText(Object object) {
		String label = ((Recipient)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_Recipient_type") :
			getString("_UI_Recipient_type") + " " + label;
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(RecipientsPackage.Literals.RECIPIENT__LOCATED_AT,
