...
/**
 * This is the item provider adapter for a {@link edu.kit.ipd.sdq.mdsd.recipients.Location} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LocationItemProvider extends IdentifiedElementItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_Location_number_feature", "_UI_Location_type"),
				 RecipientsPackage.Literals.LOCATION__NUMBER,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 RecipientsPackage.Literals.LOCATION__STREET,
				 true,
				 false,
				 false,
