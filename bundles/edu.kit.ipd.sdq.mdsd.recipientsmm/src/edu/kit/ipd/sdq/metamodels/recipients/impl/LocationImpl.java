 ...
 * </p>
 * <ul>
 *   <li>{@link edu.kit.ipd.sdq.metamodels.recipients.impl.LocationImpl#getParent <em>Parent</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.metamodels.recipients.impl.LocationImpl#getNumber <em>Number</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.metamodels.recipients.impl.LocationImpl#getStreet <em>Street</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LocationImpl extends IdentifiedElementImpl implements Location {
	/**
	...
	protected EClass eStaticClass() {
		return RecipientsPackage.Literals.LOCATION;
	}
	...
	public void setNumber(int newNumber) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RecipientsPackage.LOCATION__NUMBER, oldNumber, number));
	}
	...
	public void setStreet(String newStreet) {
		...
		street = newStreet;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RecipientsPackage.LOCATION__STREET, oldStreet, street));
	}
