...
public class EnsuranceAdapterFactory extends AdapterFactoryImpl {
	 ...
	 * @generated
	 */
	protected EnsuranceSwitch<Adapter> modelSwitch = new EnsuranceSwitch<Adapter>() {
		@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link edu.kit.ipd.sdq.metamodels.ensurance.EnsuranceDatabase <em>Database</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link edu.kit.ipd.sdq.metamodels.ensurance.EnsuranceClient <em>Client</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
