...
import edu.kit.ipd.sdq.metamodels.confidentiality4cbse.system.AbstractSpecificationParameterAssignement;
 ...
 * @generated
 */
public class AbstractSpecificationParameterAssignementItemProvider extends EntityItemProvider
{
	/**
	...
	{
		String label = ((AbstractSpecificationParameterAssignement)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_AbstractSpecificationParameterAssignement_type") :
			getString("_UI_AbstractSpecificationParameterAssignement_type") + " " + label;
	}
